...
```{r}
Auto_01 <- data.frame(Auto, mpg01)
View(Auto_01)
```

 (b) Explore the data graphically in order to investigate the association between mpg01 and the other features. Which of the other features seem most likely to be useful in predicting mpg01? Scatterplots and boxplots may be useful tools to answer this question. Describe your findings. 
```{r}
plot(Auto_01$mpg01,Auto_01$displacement)
plot(Auto_01$mpg01,Auto_01$weight)
plot(Auto_01$mpg01,Auto_01$horsepower)
plot(Auto_01$mpg01,Auto_01$acceleration)
```
```{r}
...
```{r}
set.seed(123)
train<-sample(nrow(Auto_01), size = nrow(Auto_01)*0.70)
train_data=Auto_01[train,]
test_data=Auto_01[-train,]
